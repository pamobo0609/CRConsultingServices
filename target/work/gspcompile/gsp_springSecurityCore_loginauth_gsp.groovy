...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',86,['code':("springSecurity.login.header")],-1)
printHtmlPart(5)
...
printHtmlPart(9)
invokeTag('message','g',94,['code':("springSecurity.login.username.label")],-1)
printHtmlPart(10)
invokeTag('message','g',99,['code':("springSecurity.login.password.label")],-1)
printHtmlPart(11)
...
printHtmlPart(14)
invokeTag('message','g',105,['code':("springSecurity.login.remember.me.label")],-1)
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1460783598852L
