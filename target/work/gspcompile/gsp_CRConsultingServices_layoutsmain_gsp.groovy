...
class gsp_CRConsultingServices_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(2)
expressionOut.print(assetPath(src: 'fav.ico'))
printHtmlPart(3)
...
printHtmlPart(9)
invokeTag('image','asset',22,['src':("logo_full.jpg"),'alt':("CRCS")],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1460783598195L
