		...
		<div id="list-provincia" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombreProvincia" title="${message(code: 'provincia.nombreProvincia.label', default: 'Nombre Provincia')}" />
				...
				<g:each in="${provinciaInstanceList}" status="i" var="provinciaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${provinciaInstance.id}">${fieldValue(bean: provinciaInstance, field: "nombreProvincia")}</g:link></td>
