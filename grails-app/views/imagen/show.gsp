	...
	<body>
		...
		<div id="show-imagen" class="content scaffold-show" role="main">
			...
			<ol class="property-list imagen">
				...
				<g:if test="${imagenInstance?.descripcion}">
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="imagen.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${imagenInstance}" field="descripcion"/></span>
